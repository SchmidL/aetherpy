...
vs_flat = viewshed_sweep(dem, obs_rc, obs_h=1.75, max_dist=5000.0)

# visualize
plot_viewshed(dem, vs_flat, observer=obs_rc)	

# compute a 5 km viewshed at 1.75 m observer height
vs_curved = viewshed_sweep(dem, obs_rc, obs_h=1.75, max_dist=5000.0,curvature_k = 1.3)

# visualize
plot_viewshed(dem, vs_curved, observer=obs_rc)	